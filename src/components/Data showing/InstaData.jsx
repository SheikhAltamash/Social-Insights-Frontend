            ...
            <div className="main_div_post_fb">
                ...
                {loading ? (
                    ...
                    <div className="options">
                        ...
                        <div
                            className={`one_option ${activeOption === "Messages" ? "active" : ""
                                }`}
                        ...
                        <div
                            className={`one_option ${activeOption === "Followers" ? "active" : ""
                                }`}
                                    ...
                                    data.post.map((post, index) => (
                                        <div key={index} className="post_div">
                                            <img
                                                ...
                                                alt="Post"
                                                className={`post_img ${selectedPosts.includes(index) ? "selected" : ""
                                                    }`}
